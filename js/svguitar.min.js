        ...
        SVGuitarChord.prototype.drawTunings = function (y) {
            ...
            tuning.forEach(function (tuning_, i) {
                if (i < strings) {
                    ...
                    var tuningText = _this.renderer.text(tuning_, textX, textY+18, tuningsFontSize, color, fontFamily, Alignment.MIDDLE, classNames, true);
                    if (tuning_) {
                        text = tuningText;
                    }
                }
        ...
        SVGuitarChord.prototype.drawFinger = function (x, y, size, color, textSize, fontFamily, fingerOptions, classNames) {
            ...
            switch (shape) {
                case exports.Shape.CIRCLE:
                    ...
                    break;
                case exports.Shape.EMPTYCIRCLE:
                    this.renderer.circle(x0, y0, size, 3, fingerStrokeColor, (_k = "#FFFFFF") !== null && _k !== void 0 ? _k : color, classNamesWithShape);
                    break;
